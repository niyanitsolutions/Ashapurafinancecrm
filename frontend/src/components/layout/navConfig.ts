...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Tasks", to: "/tasks", icon: "tasks", matchKey: "tasks", comingSoon: true },
    ],
  },
  {
    label: null,
  ...
  {
    label: null,
    items: [{ label: "Message Center", to: "/communication", icon: "communication", matchKey: "communication", comingSoon: true }],
  },
  {

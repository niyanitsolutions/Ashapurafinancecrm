...
// "Add Other Document" — staff requests a document by NAME (free text), the customer
// sees exactly this name in their portal and uploads against it, then staff Preview/
// Download/Verify/Reject here. Ad-hoc and per-case: it never touches the Product Schema,
// and an unverified Other Document does NOT block moving the case forward.
export function AddOtherDocumentPanel({ caseId, canEdit }: { caseId: string; canEdit: boolean }) {
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="flex items-end gap-2">
          <div className="flex-1">
            <FormField
              ...
              placeholder="e.g. Previous Policy Copy"
            />
          </div>
      ...
      {documents.length === 0 && <p className="text-sm text-text/40">No other documents requested yet.</p>}
